...
import { Input as InputText, Button, Select, Paginator as LinkPaginator, DataTable as Table, ButtonMenu, TableActions, CustomizeColumns } from '@/components/composed';
