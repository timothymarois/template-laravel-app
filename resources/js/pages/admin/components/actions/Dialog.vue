        ...
        <div class="space-y-4">
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>Simple modal dialogs for focused interactions</CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>Pre-built confirmation dialogs for common actions</CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <Card>
                <CardHeader>
                    <CardTitle>Draggable Dialog</CardTitle>
                    <CardDescription>Dialogs that can be repositioned by dragging</CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>Dialogs with forms for data entry</CardDescription>
                </CardHeader>
                <CardContent class="space-y-4">
                    <div>
                        <h4 class="text-sm font-medium mb-3">Basic Form</h4>
            ...
            <Card>
                <CardHeader>
                    <CardTitle>Gradient Header Dialog</CardTitle>
                    <CardDescription>Dialogs with styled gradient headers</CardDescription>
                </CardHeader>
                <CardContent>
                    <div class="flex gap-2">
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>Dialogs with scrollable content areas</CardDescription>
                </CardHeader>
                <CardContent class="space-y-4">
                    <div>
                        <h4 class="text-sm font-medium mb-3">Content Scrolls</h4>
                    ...
                    <div>
                        <h4 class="text-sm font-medium mb-3">Page Scrolls</h4>
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>Styled dialogs for different alert types</CardDescription>
                </CardHeader>
                <CardContent>
                    <div class="flex gap-2">
...
import { Check, Info, AlertTriangle, CheckCircle, X } from 'lucide-vue-next';
