...
<template>
    <CheckboxRoot
        v-bind="forwarded"
        :class="
            cn('group peer relative h-4 w-4 shrink-0 rounded-sm border border-ring bg-background transition-all cursor-pointer hover:border-foreground/50 focus-visible:outline-none focus-visible:border-foreground/50 disabled:cursor-not-allowed disabled:opacity-50 disabled:hover:border-ring data-[state=checked]:border-primary data-[state=checked]:bg-primary data-[state=checked]:text-primary-foreground data-[state=checked]:hover:bg-primary/80 data-[state=checked]:disabled:hover:bg-primary',
                 props.class)"
    >
