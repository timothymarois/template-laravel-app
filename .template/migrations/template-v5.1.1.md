...
Bump the fork's `template-manifest.json` → `"version": "5.1.1"`. Don't copy this changelog into the fork — the manifest `version` is the record (see the template's [`.template/README.md`](../README.md)).
