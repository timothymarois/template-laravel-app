...
class TenancyServiceProvider extends ServiceProvider
{
    ...
    {
        // Master switch. When tenancy is disabled the entire boot is a no-op:
        // no event listeners bound, no tenant routes loaded, no middleware
        // priority overrides. This preserves the v5.0.0 disabled-state contract.
