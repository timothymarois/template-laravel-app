...
return [
    /**
     * Master switch. When false, App\Providers\TenancyServiceProvider::boot()
     * short-circuits and no tenancy code runs. Default false — tenancy is opt-in
     * per template-laravel-app v5.0.0.
     *
     * Wrapped in filter_var so phpunit's <env value="true"/> (which putenv's
     * as the string "1") and shell env exports (which may be "true"/"1"/"yes")
     * all coerce to a proper boolean.
     */
     ...
     * Switch to 'subdomain' once wildcard DNS + SSL are ready.
     */
     ...
     * Reads comma-separated from TENANCY_CENTRAL_DOMAINS env; defaults to local Herd hosts.
     */
