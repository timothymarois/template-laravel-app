...
- **Active areas:** the Laravel app itself — auth, admin dashboard/users, the Vue/Inertia UI and shadcn-vue component showcase, health checks, and testing. Multi-tenancy ships but is inert by default.
